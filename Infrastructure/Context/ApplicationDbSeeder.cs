...
namespace Infrastructure.Context
{
    public class ApplicationDbSeeder(
            IMultiTenantContextAccessor<ABCCompanyTenantInfo> tenantInfoContextAccessor,
            RoleManager<ApplicationRole> roleManager,
            UserManager<ApplicationUser> userManager,
            ApplicationDbContext applicationDbContext)
    {
        private readonly IMultiTenantContextAccessor<ABCCompanyTenantInfo> _tenantInfoContextAccessor = tenantInfoContextAccessor;
        ...
        private async Task AssignPermissionsToRoleAsync(
            IReadOnlyList<CompanyPermission> incomingRolePermissions,
